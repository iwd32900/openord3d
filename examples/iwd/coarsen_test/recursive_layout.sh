...
# general inputs
ROOTNAME=aranet				# root name of project
MEMORY=1				# use multiple scans to conserve memory

# initial layout & clustering
TRUNCATE_LINKS=20	# initial truncation number of edges
...
SCALE=200		# scale coarsest layout up; CANNOT exceed 256 or we crash
